...
GROUP_ORDER = {
    ...
    ("HDEA", 4, 100, 5, 2): 3,
    ("HDEA", 6, 100, 5, 3): 4,
    ("MOVING_HDEA", 4, 100, 5, 2): 5,
    ("MOVING_HDEA", 6, 100, 5, 3): 6,
}
...
COMPARISONS = [
    ...
    (("SERIAL", 1, 0, 0, 0), ("MOVING_HDEA", 4, 100, 5, 2)),
    (("SERIAL", 1, 0, 0, 0), ("MOVING_HDEA", 6, 100, 5, 3)),
    (("DEA", 4, 100, 0, 0), ("HDEA", 4, 100, 5, 2)),
    (("DEA", 4, 100, 0, 0), ("HDEA", 6, 100, 5, 3)),
    (("DEA", 4, 100, 0, 0), ("MOVING_HDEA", 4, 100, 5, 2)),
    (("DEA", 4, 100, 0, 0), ("MOVING_HDEA", 6, 100, 5, 3)),
    (("HDEA", 4, 100, 5, 2), ("MOVING_HDEA", 4, 100, 5, 2)),
    (("HDEA", 6, 100, 5, 3), ("MOVING_HDEA", 6, 100, 5, 3)),
    (("MOVING_HDEA", 4, 100, 5, 2), ("MOVING_HDEA", 6, 100, 5, 3)),
]
...
def default_paths(argv):
    ...
    input_path = argv[1] if len(argv) > 1 else str(project_root / "results" / "final_experiment_results.csv")
    summary_path = argv[2] if len(argv) > 2 else str(project_root / "results" / "final_analysis_summary.txt")
    summary_csv_path = argv[3] if len(argv) > 3 else str(project_root / "results" / "final_analysis_summary.csv")
